...
@Component({
  ...
  <mat-form-field appearance="fill">
      <mat-label>Skrócony opis produktu</mat-label>
      <textarea matInput rows="20" placeholder="Podaj skrócony opis produktu" formControlName="description"></textarea>
    ...
    <mat-form-field appearance="fill">
      <mat-label>Pełny opis produktu (opcjonalnie)</mat-label>
